...
debug: MitoPlanar.cpp
	@$(CC) $(DFLAG) $(CFLAGS) MitoPlanar.cpp -o MitoPlanar $(VTK_DYN_LIBS) $(IGRAPH_DYN_LIBS) -I$(VTK_INCLUDE_DIR) -I$(IGRAPH_INCLUDE_DIR)

dynamic: MitoPlanar.cpp
	@$(CC) $(CFLAGS) MitoPlanar.cpp -o MitoPlanar $(VTK_DYN_LIBS) $(IGRAPH_DYN_LIBS) -I$(VTK_INCLUDE_DIR) -I$(IGRAPH_INCLUDE_DIR)

static:
	@$(CC) $(CFLAGS) MitoPlanar.cpp -o MitoPlanar $(VTK_STA_LIBS) $(IGRAPH_STA_LIBS) -I$(VTK_INCLUDE_DIR) -I$(IGRAPH_INCLUDE_DIR)